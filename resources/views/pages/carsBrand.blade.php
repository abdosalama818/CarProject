        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcromb-box">
                    <h3>{{ __('trans.OUR FLEET') }}</h3>
                    <ul>
                        <li><i class="fa fa-home"></i></li>
                        <li><a href="{{ url('/') }}">{{ __('trans.Home') }}</a></li>
                        <li><i class="fa fa-angle-right"></i></li>
                        <li>{{ __('trans.OUR FLEET') }}</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="car-listing-right">
                    <div class="property-page-heading">
                        <div class="paging_status">
                            <p>{{ __("trans.1-10 of 25 results") }}</p>
                        </div>
                                ...
                                <div class="single-offers">
                                    ...
                                    <div class="offer-text">
                                        ...
                                        <ul>
                                            ...
                                            <li><i class="fa fa-cogs"></i>{{ __("trans.Automatic") }}</li>
                                            <li><i class="fa fa-dashboard"></i>20kmpl</li>
                                        </ul>
                                        <div class="offer-action">
                                            <a href="{{route('car.reserve',$car->id)}}" class="offer-btn-1">{{ __("trans.RENT CAR") }}</a>
                                            <a href="{{route('car.details',$car->id)}}" class="offer-btn-2">{{ __("transDETAILS") }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
