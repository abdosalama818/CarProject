                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>17-2-2023 8:30</td>
                                        <td>22-2-2023 8:30</td>
                                        <td>
                                            <div>
                                                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">Reservation Details</button>
