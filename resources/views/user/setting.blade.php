                                ...
                                <div class="card-body">
                                    <form>
                                            ...
                                            <div class="profile-title">
                                                <div class="media"><img class="img-70 rounded-circle" alt=""
                                                    ...
                                                    <div class="media-body">
                                                        <h3 class="mb-1 f-20 txt-primary">Ahmed Karem</h3>
                                                        <p class="f-12">user</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" placeholder="012345678">
                                        </div>
                                        <div class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" placeholder="Job">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Work Address</label>
                                                <input class="form-control" type="text" placeholder="Work Address">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
