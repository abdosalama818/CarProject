                ...
                <ul class="nav-menus">
                       ...
                       <li class="onhover-dropdown">
                        <div class="notification-box">
                            ...
                            </svg><span class="badge rounded-pill badge-warning">{{ Auth::user()->unreadNotifications ->count() }} </span>
                        </div>
                        <div class="onhover-show-div notification-dropdown">
                            <div class="dropdown-title">
                                <h3>Notification</h3><a class="f-right" href="#"> <i data-feather="bell">                           </i></a>
                            </div>
                                ...
                                <li>{{--  --}}
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5> <a class="f-14 m-0" href="{{ route("dashbord.request_car_id",$notification->data['order_id']) }}">{{ $notification->data['order']['name'] }}</a></h5>
                                            <p></p><span>{{ $notification->created_at }}</span>
                                        </div>
                ...
                <nav class="sidebar-main">
                    ...
                    <div id="sidebar-menu">
                        <ul class="sidebar-links" id="simple-bar">
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="{{route('whichlist.show')}}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
